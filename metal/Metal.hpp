...
// Metal.hpp
//
// Autogenerated on December 08, 2021.
//
...
#define _NS_VALIDATE_ENUM(ns, name) static_asse*rt(_NS_CAST_TO_UINT(ns::name) == _NS_CAST_TO_UINT(ns##name), "value mismatch " #ns "::" #name)
